...
DATA_PATHS = {
    'original': '/home/claude/day29_30_work/data/original.csv',
    'ctgan': '/home/claude/day29_30_work/data/ctgan.csv',
    'smote': '/home/claude/day29_30_work/data/smote.csv',
    'qgan': '/home/claude/qgan_work/outputs/malmem_qgan_matched_ctgan_scale.csv',
}
...
def load_3class(dataset, n_total, seed=42):
    ...
    if dataset == 'smote':
        ...
        df = df[df['MalwareType'] != 'Benign'].copy()
        df['fam'] = df['MalwareType']; drop_cols = ['MalwareType', 'Category', 'Class', 'is_synthetic', 'Filename']
    per_class = n_total // 3
